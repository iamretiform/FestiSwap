...
ActiveRecord::Schema.define(version: 20170511025301) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.string "slug"
    t.datetime "start_date"
    t.string "theme_song_file_name"
    t.string "theme_song_content_type"
    t.integer "theme_song_file_size"
    t.datetime "theme_song_updated_at"
  ...
  create_table "theme_songs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
